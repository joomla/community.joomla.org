...
<?php if ($params->get('show_title')) : ?>
	<h2 class="item-title-lead" itemprop="name">
...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<div class="item-image"><a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>" itemprop="url"> <img
